package com.auditionstreet.castingagency.ui.chat.adapter
...
import com.auditionstreet.castingagency.ui.chat.PROPERTY_FORWARD_USER_NAME
import com.auditionstreet.castingagency.ui.chat.adapter.listeners.PaginationHistoryListener
import com.auditionstreet.castingagency.ui.chat.adapter.manager.PROPERTY_NOTIFICATION_TYPE
import com.auditionstreet.castingagency.utils.chat.*
import com.auditionstreet.castingagency.utils.chat.QbDialogHolder.clear
...
class ChatAdapter(protected var context: Context,
        ...
        attachment?.let {
            ...
            when {
                ...
                file -> {
                    ...
                    showToast(context, "Unknown Attachment Received")
                }
            }
        }
    }
    ...
    inner class NewMessageViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var avatar: CircularImageView? = itemView.findViewById(R.id.civ_avatar)
            ...
            holder.llMessageContainer?.let {
                ...
                if (iterator != null && iterator.hasNext()) {
                    ...
                    if (isAttachmentValid(attachment)) {
                        ...
                        showToast(context, context.getString(R.string.error_attachment_corrupted))
                    }
                }
            }
        }
