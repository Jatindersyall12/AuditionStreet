...
import com.auditionstreet.artist.ui.chat.GetFilepathFromUriTask
import com.auditionstreet.castingagency.ui.chat.adapter.listeners.OnImagePickedListener
import com.auditionstreet.artist.utils.CAMERA_REQUEST_CODE
import com.auditionstreet.artist.utils.FILE_REQUEST_CODE
import com.auditionstreet.artist.utils.GALLERY_REQUEST_CODE
import com.auditionstreet.artist.utils.getLastUsedCameraFile
...
class MediaPickHelperFragment : Fragment() {
    ...
    override fun onActivityResult(requestCode: Int, resultCode: Int, data: Intent?) {
        ...
        if (isResultFromImagePick(requestCode, resultCode, intent)) {
            ...
            GetFilepathFromUriTask(childFragmentManager, listener, requireArguments().getInt(ARG_REQUEST_CODE)).execute(intent)
        } else {
