...
class SkinToneListAdapter(
    val mContext: FragmentActivity, private val mCallback: (
        mposition: String
    ) -> Unit
) :
    RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    val DIFF_CALLBACK = object : DiffUtil.ItemCallback<GetBodyTypeLanguageResponse.Data.SkinTone>() {

        override fun areItemsTheSame(
            oldItem: GetBodyTypeLanguageResponse.Data.SkinTone,
            newItem: GetBodyTypeLanguageResponse.Data.SkinTone
        ): Boolean {
    ...
    fun submitList(projectResponse: ArrayList<GetBodyTypeLanguageResponse.Data.SkinTone>) {
    ...
    inner class ConnectionHolder(
        ...
        fun bind(item: GetBodyTypeLanguageResponse.Data.SkinTone) = with(itemView) {
