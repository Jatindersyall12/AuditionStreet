package com.auditionstreet.castingagency.ui.chat.adapter.manager
...
class DialogsManager {
    ...
    private fun buildMessageCreatedGroupDialog(dialog: QBChatDialog): QBChatMessage {
        ...
        qbChatMessage.body = AppCastingAgency.getInstance().getString(R.string.new_chat_created, getCurrentUserName(), dialog.name)
    ...
    private fun buildMessageAddedUsers(dialog: QBChatDialog, userIds: String, usersNames: String): QBChatMessage {
        ...
        qbChatMessage.body = AppCastingAgency.getInstance().getString(R.string.occupant_added, getCurrentUserName(), usersNames)
        qbChatMessage.setSaveToHistory(true)
        qbChatMessage.isMarkable = true
        return qbChatMessage
    }
    ...
    private fun buildMessageLeftUser(dialog: QBChatDialog): QBChatMessage {
        ...
        qbChatMessage.body = AppCastingAgency.getInstance().getString(R.string.occupant_left, getCurrentUserName())
        qbChatMessage.setSaveToHistory(true)
        qbChatMessage.isMarkable = true
        return qbChatMessage
    }
    ...
    fun sendMessageAddedUsers(dialog: QBChatDialog, newUsersIds: List<Int>) {
        ...
        loadNewUsersByIDs(newUsersIds, requestBuilder, ArrayList(), object :
