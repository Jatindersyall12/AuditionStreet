...
import com.auditionstreet.castingagency.utils.chat.getColorCircleDrawable
import com.auditionstreet.castingagency.utils.chat.getDialogName
...
class DialogsAdapter(var context: Context, var dialogs: List<QBChatDialog>) : BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup): View {
        ...
        if (isItemSelected(position)) {
            ...
            backgroundColor = context.resources.getColor(R.color.orange)
        } else {
