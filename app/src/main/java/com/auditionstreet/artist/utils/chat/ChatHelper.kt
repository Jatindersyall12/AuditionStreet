...
import com.auditionstreet.artist.*
import com.auditionstreet.castingagency.*
import com.auditionstreet.castingagency.utils.chat.callBacks.QbEntityCallbackTwoTypeWrapper
import com.auditionstreet.castingagency.utils.chat.callBacks.QbEntityCallbackWrapper
...
object ChatHelper {
    ...
    fun createDialogWithSelectedUsers(users: QBUser, chatName: String, callback: QBEntityCallback<QBChatDialog>) {
    ...
    fun deleteDialog(qbDialog: QBChatDialog, callback: QBEntityCallback<Void>) {
        if (qbDialog.type == QBDialogType.PUBLIC_GROUP) {
           // showToast(R.string.public_group_chat_cannot_be_deleted)
        } else {
